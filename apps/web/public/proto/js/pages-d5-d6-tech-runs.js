...
function ClientContext({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    className: signalFilter === "positive" ? "on" : "",
    onClick: () => setSignalFilter("positive"),
    style: {
      color: signalFilter === "positive" ? "var(--z-mid)" : "var(--z-muted)"
    }
  }, "Positive"), /*#__PURE__*/React.createElement("button", {
    className: signalFilter === "neutral" ? "on" : "",
    onClick: () => setSignalFilter("neutral")
  }, "Neutral"), /*#__PURE__*/React.createElement("button", {
    className: signalFilter === "negative" ? "on" : "",
    onClick: () => setSignalFilter("negative"),
    style: {
      color: signalFilter === "negative" ? "var(--z-below)" : "var(--z-muted)"
    }
    ...
    className: "co-title"
  }, "Open enforcement \xB7 IS-014"), /*#__PURE__*/React.createElement("div", {
    className: "co-body"
  }, issues[0].desc, " \xB7 click to view caps")), /*#__PURE__*/React.createElement(Icon, {
    name: "arrow-r",
    size: 12
  })), /*#__PURE__*/React.createElement("button", {
    ...
    onClick: () => openEvidence("E-218")
  }, "View evidence ", /*#__PURE__*/React.createElement(Icon, {
    name: "arrow-r",
    size: 12
  }))))), /*#__PURE__*/React.createElement("div", {
    className: "g2"
...
function EventDetail({
  ...
  return /*#__PURE__*/React.createElement("div", {
    style: {
      ...
      background: "var(--z-lav)",
      borderRadius: 8,
      borderLeft: `4px solid ${TONE[event.signal]}`
    }
  }, /*#__PURE__*/React.createElement("div", {
    className: "row",
    style: {
  ...
  }, event.cap_impact), /*#__PURE__*/React.createElement("span", {
    className: "spacer"
  }), /*#__PURE__*/React.createElement("span", {
    className: "b b-muted"
  }, event.signal.toUpperCase()), /*#__PURE__*/React.createElement("button", {
    className: "icon-btn",
    onClick: onClose
  }, /*#__PURE__*/React.createElement(Icon, {
    name: "x",
  ...
  }, event.signal === "positive" ? "Positive signal - increases the maturity ceiling on the affected capability." : event.signal === "negative" ? "Negative signal - caps the maturity score on the affected capability." : "Neutral signal - context for understanding the entity's trajectory, no direct score effect."), event.evidence.length > 0 ? /*#__PURE__*/React.createElement("div", {
    className: "row",
    style: {
      flexWrap: "wrap",
      gap: 6
...
function ClientHealth({
  ...
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    }, e.source.split("/")[0]), /*#__PURE__*/React.createElement("td", null, e.recency), /*#__PURE__*/React.createElement("td", null, age, " mo"), /*#__PURE__*/React.createElement("td", {
      style: {
        textAlign: "right"
      }
    }, /*#__PURE__*/React.createElement("span", {
...
function TechRow({
  ...
  }, t.status), t.evidence.map(eid => /*#__PURE__*/React.createElement("button", {
    key: eid,
    className: "chip purple",
    style: {
      fontSize: 10,
  ...
  }, t.note), t.subcaps_impact && t.subcaps_impact.length > 0 ? /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 4,
      marginTop: 6,
