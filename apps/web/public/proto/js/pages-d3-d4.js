...
function l3Label(code) {
  if (_l3Map === null) {
    _l3Map = new Map();
    const rows = typeof window !== "undefined" && window.DMA_LIVE && window.DMA_LIVE.l3_platforms || [];
    for (const r of rows) {
      if (!r || !r.id) continue;
...
function areaLabel(v) {
  ...
  const out = raw.replace(/\[(L3-[A-Za-z0-9._-]+)\]([^>|·]*)/g, (_m, code, rest) => {
...
function BenchmarkChip({
  ...
  }, mark.value.toFixed(1), " ", /*#__PURE__*/React.createElement("span", {
    style: {
      opacity: .7
    }
  }, mark.grain));
...
function ClientPlatform({
  ...
  const storyGapRow = (g, scoped) => ({
    ...
    path: areaLabel(g.catalogue_path),
    e_ids: g.e_ids || [],
  ...
  /* The run's own benchmark table. `workbookScoresOf` lives on the heatmap
     ...
     answer. */
  const wbScores = (typeof workbookScoresOf === "function" ? workbookScoresOf(entity) : null) || entity && entity.workbookScores || null;
  ...
  const anyPeer = gapRows.some(g => g.peer !== null || benchmarkFor(g.subcap_id, wbScores) !== null);
  ...
  React.createElement("div", {
    ...
    // real one.
    const mark = peer === null ? benchmarkFor(g.subcap_id, wbScores) : null;
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, {
      ...
      score: peer
    }) : mark ? /*#__PURE__*/React.createElement(BenchmarkChip, {
      mark: mark
    ...
    React.createElement("td", {
      ...
      // rows.
      const d = delta !== null ? delta : mark !== null && cur !== null ? cur - mark.value : null;
      if (d === null) {
      ...
      return /*#__PURE__*/React.createElement("span", {
        className: "f-mono",
        style: {
          color: d < 0 ? "var(--z-below)" : "var(--z-above)",
          opacity: inherited ? .8 : 1
        },
        title: inherited ? `Against the ${mark.grain} benchmark for ${mark.of}, not against a peer figure for this cell — the run states none.` : ""
      }, d > 0 ? `+${d.toFixed(1)}` : d.toFixed(1), inherited ? /*#__PURE__*/React.createElement("span", {
        style: {
          opacity: .7
        }
      }, " ", mark.grain) : null);
    ...
    }, pfText(areaLabel(r.l3))) : null, r.l4 ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "var(--z-mid)",
        marginBottom: 5,
...
function StairstepCurve({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const blockers = ((s.blocking_refs || []).length ? s.blocking_refs : s.blocking || []).map(b => ({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      title: "effort band"
    }, pfText(s.effort)) : null, blockers.filter(b => b.id).map(b => /*#__PURE__*/React.createElement("span", {
      key: b.id,
      className: "b b-org",
      style: {
        flexShrink: 0
    ...
    }, pfText(s.label)), blockerProse.length ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 11,
        color: "var(--z-body)",
        lineHeight: 1.5,
    ...
    }, blockerProse.length === 1 ? "Blocking finding" : "Blocking findings"), " ", blockerProse.join(" · ")) : null, via ? /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 10,
        color: "var(--z-mid)",
        marginTop: 3
