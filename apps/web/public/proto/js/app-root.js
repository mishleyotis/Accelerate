...
const FIRMO_PINNED = new Set(["total_assets", "assets", "aum", "employees", "branches", "primary_regulator", "member_count", "customer_count", "net_worth_ratio", "founded", "founded_year", "charter", "hq", "website", "web site", "domain", "primary domain", "web domain", "entity website", "url"]);
