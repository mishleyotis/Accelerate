...
(function () {
  ...
  if (!_B) {
    ...
    throw new Error(
      "DMA_BANDS is not loaded: proto/bands.js must be the first script " +
      "(see apps/web/app/route.js SCRIPTS). Refusing to fall back to a " +
      "second colour mapping — that is the invariant-7 defect this file " +
  ...
  const SUBCAP_LEAVES = [
    "Framework & Standards", "Operating Model", "Process Automation", "Telemetry & Metrics",
    "Governance & Controls", "Tooling & Platform", "Playbook & Runbooks", "Continuous Improvement",
    "Integration & Interop", "Roles & Ownership",
  ];
    ...
    for (const cat of CATEGORIES) {
      ...
      clusters.forEach((clusterName, ci) => {
        ...
        for (let li = 0; li < leafCount; li++) {
          ...
          out.push({
            id, name: `${clusterName} · ${SUBCAP_LEAVES[li % SUBCAP_LEAVES.length]}`,
            l1: ci + 1, l1name: clusterName,
            category: cat.id, pillar: cat.pillar, score, peerMedian, evidence_count: evCount,
            confidence: thin ? "LOW" : (evCount > 5 ? "HIGH" : "MEDIUM"),
            thin, platforms, locked,
            weight: cat.weight,
          });
        }
      });
  ...
  const EVIDENCE = [
    { id: "E-047", title: "FCE 2025 annual report - IT modernization disclosure", source: "farmcrediteast.com/annual-report-2025.pdf", source_pretty: "FCE annual report 2025", tier: "T1", ers: 0.92, claim: "FACT",          recency: "2025-Q4", subcaps: ["P4C1.1.1","P4C1.1.2","P4C4.2.1"], excerpt: "We are mid-migration from our legacy core to nCino with target completion in Q2 2026. The transition has temporarily increased data complexity across three production systems." },
    { id: "E-089", title: "Q1 2026 earnings call - CIO commentary",                source: "seekingalpha.com/transcript/fce-q1-2026",   source_pretty: "Earnings call · Q1 2026",      tier: "T2", ers: 0.81, claim: "INFERENCE",     recency: "2026-Q1", subcaps: ["P4C1.2.1","P4C1.3.1"],            excerpt: "[CIO] We've been evaluating Data Cloud as a customer 360 layer for about six months - we have not yet selected a vendor, but it's a priority for FY27." },
    { id: "E-112", title: "Job posting - Data Cloud Architect (LinkedIn)",         source: "linkedin.com/jobs/view/40-data-cloud-architect", source_pretty: "LinkedIn job · Data Cloud Architect", tier: "T7", ers: 0.74, claim: "INFERENCE",     recency: "2026-Q1", subcaps: ["P4C1.2.1","P4C3.1.1"],            excerpt: "Lead the build-out of our enterprise Customer Data Platform on Salesforce Data Cloud..." },
    { id: "E-141", title: "10-K filing - Risk factors",                          source: "sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=...", source_pretty: "10-K filing 2025", tier: "T1", ers: 0.93, claim: "FACT",          recency: "2025-Q3", subcaps: ["P4C1.1.1","P4C4.2.1"],            excerpt: "We face risk from system integration delays following multiple core system platform consolidations." },
    { id: "E-203", title: "CDO LinkedIn announcement - new hire",                   source: "linkedin.com/in/raj-iyer-cdo/",            source_pretty: "Raj Iyer LinkedIn", tier: "T4", ers: 0.62, claim: "INFERENCE",     recency: "2026-Q2", subcaps: ["P1C4.1.1","P4C1.3.1"],            excerpt: "Excited to join Farm Credit East as Chief Data Officer to lead a multi-year data foundation transformation." },
    { id: "E-218", title: "AML enforcement action - FRB consent order",             source: "federalreserve.gov/enforcement/cease-and-desist", source_pretty: "FRB consent order", tier: "T1", ers: 0.95, claim: "FACT",          recency: "2024-Q4", subcaps: ["P1C2.1.1","P1C2.2.1","P4C5.2.1"], excerpt: "Consent order requires remediation of transaction monitoring controls within 18 months." },
    { id: "E-236", title: "Glassdoor reviews - operations team",                    source: "glassdoor.com/Reviews/FCE-ops",            source_pretty: "Glassdoor · Operations",    tier: "T6", ers: 0.58, claim: "HYPOTHESIS",   recency: "2026-Q1", subcaps: ["P3C2.1.1","P3C2.2.1"],            excerpt: "Manual loan processing - too many spreadsheets and PDF re-keying." },
    { id: "E-250", title: "Press release - Tableau Cloud deployment",                source: "fce.com/news/tableau-cloud-deployment-2025", source_pretty: "FCE press release · 2025-Q2", tier: "T2", ers: 0.86, claim: "FACT",          recency: "2025-Q2", subcaps: ["P4C2.1.1","P4C2.2.1"],            excerpt: "FCE has completed enterprise-wide rollout of Tableau Cloud to 1,800 employees." },
    { id: "E-271", title: "App store reviews - mobile app",                          source: "apps.apple.com/us/app/farm-credit-east", source_pretty: "Apple App Store reviews", tier: "T6", ers: 0.66, claim: "INFERENCE",     recency: "2026-Q2", subcaps: ["P2C1.1.1","P2C2.2.1"],            excerpt: "Mobile transfers are slow. Branch staff still required for many tasks." },
    { id: "E-283", title: "Job posting - Tableau Pulse Specialist",                  source: "indeed.com/viewjob?jk=tableau-pulse",       source_pretty: "Indeed · Tableau Pulse",    tier: "T7", ers: 0.71, claim: "INFERENCE",     recency: "2026-Q2", subcaps: ["P4C2.2.1","P4C3.1.1"],            excerpt: "Help our growing analytics team rollout Tableau Pulse to relationship managers." },
    { id: "E-302", title: "WSJ - regional bank consolidation trends",                source: "wsj.com/articles/regional-bank-consolidation", source_pretty: "Wall Street Journal", tier: "T3", ers: 0.78, claim: "INFERENCE",     recency: "2025-Q4", subcaps: ["P1C1.1.1"],                       excerpt: "Regional banks face mounting pressure to consolidate technology stacks as digital expectations rise." },
    { id: "E-311", title: "Forrester - Banking CX 2026 Q1",                          source: "forrester.com/report/banking-cx-q1-2026",   source_pretty: "Forrester analyst report", tier: "T3", ers: 0.82, claim: "INFERENCE",     recency: "2026-Q1", subcaps: ["P2C1.1.1","P2C4.1.1"],            excerpt: "Regional and community banks trail national peers in mobile-first servicing by 14 months on average." },
    { id: "E-340", title: "Subreddit /r/farmcredit thread",                          source: "reddit.com/r/farmcredit/comments/abc",      source_pretty: "Reddit thread",          tier: "T8", ers: 0.35, claim: "HYPOTHESIS",   recency: "2026-Q1", subcaps: ["P2C2.1.1"],                       excerpt: "Always have to call my rep for anything - there's no self-service for ag loans." },
  ];

  /* ── Insight cards (Client Profile) ─────────────────────────── */
  const INSIGHT_CARDS = LIVE ? [] : [
    {
      id: "IC-003", pillar: "P4", flag: "CRITICAL", confidence: "HIGH", theme: "Data foundation",
    ...
    {
      id: "IC-007", pillar: "P2", flag: "OPPORTUNITY", confidence: "HIGH", theme: "Customer experience",
      ...
      platforms: ["SF","TW"],
      rec: "REC-07",
      annotation: { author: "M. Otiende", role: "ANALYST", body: "Discussed with Delivery Lead before the Farm Credit call. CIO mentioned they have been evaluating Data Cloud for 6 months but have not committed. Connected to SF opportunity SF-2847.", status: "ACTIONED", when: "Jun 2, 2026 · 9:32 AM" },
    },
    {
      id: "IC-009", pillar: "P3", flag: "OPPORTUNITY", confidence: "MEDIUM", theme: "Operational efficiency",
    ...
    {
      id: "IC-011", pillar: "P1", flag: "MONITOR", confidence: "HIGH", theme: "Risk & compliance",
    ...
    {
      id: "IC-014", pillar: "P4", flag: "OPPORTUNITY", confidence: "HIGH", theme: "Data & AI",
    ...
    {
      id: "IC-018", pillar: "P2", flag: "CRITICAL", confidence: "MEDIUM", theme: "Customer experience",
  ...
  const RECOMMENDATIONS = [
    { id: "REC-04",  title: "Establish unified customer data foundation",   platform: "SF",  feature: "Data Cloud",        phase: "Phase 1 (0–6 mo)", root_cause: ["E-047","E-141"], outcomes: { time: "6-9 months",  effort: "M",  metric: "Single customer view across 3 core systems", peer: "Synovus, M&T" } },
    { id: "REC-07",  title: "Sequence Marketing Cloud + Twilio Engage",      platform: "SF",  feature: "Marketing Cloud",   phase: "Phase 2 (6–12 mo)", root_cause: ["E-089"],         outcomes: { time: "9-12 months", effort: "M",  metric: "Multi-channel campaign attribution", peer: "TD Bank" } },
    { id: "REC-09",  title: "nCino Workflow Engine on loan origination",     platform: "nCino", feature: "Workflow Engine", phase: "Phase 1 (0–6 mo)",  root_cause: ["E-236"],         outcomes: { time: "5-7 months", effort: "S",  metric: "Loan origination cycle ↓ 40%", peer: "First Citizens" } },
    { id: "REC-14",  title: "Mosaic AI on Databricks for decisioning",       platform: "DB",  feature: "Mosaic AI",         phase: "Phase 3 (12-18 mo)", root_cause: ["E-250","E-283"], outcomes: { time: "12-18 months", effort: "L", metric: "Real-time risk scoring & next-best-action", peer: "Capital One" } },
    { id: "REC-18",  title: "Mobile self-service uplift",                    platform: "TW",  feature: "Engage",            phase: "Phase 2 (6–12 mo)", root_cause: ["E-271"],         outcomes: { time: "8-10 months", effort: "M",  metric: "Branch deflection rate +18pts", peer: "BMO, Truist" } },
  ];
  ...
  const ISSUES = [
    { id: "IS-014", type: "Regulatory",     severity: "MATERIAL", desc: "AML consent order - transaction monitoring remediation track on schedule.", caps: ["P1C2","P4C5"], cap_value: 3.0, status: "OPEN", start: "2024-12", end: null },
    { id: "IS-018", type: "Process",        severity: "MINOR",    desc: "Quarterly close cycle delays in finance ops.", caps: ["P3C3"], cap_value: 3.5, status: "RESOLVED", start: "2025-Q2", end: "2025-Q4" },
    { id: "IS-021", type: "Data quality",   severity: "MATERIAL", desc: "Customer master data quality issues - duplicate records across 3 cores.", caps: ["P4C1","P2C3"], cap_value: 2.5, status: "OPEN", start: "2025-Q1", end: null },
    { id: "IS-027", type: "Operational",    severity: "MINOR",    desc: "Branch network rationalization in upstate NY.", caps: ["P2C1"], cap_value: 3.5, status: "OPEN", start: "2025-Q4", end: null },
  ];

  /* ── Timeline events (Digital Evolution Timeline) ───────────────── */
  const TIMELINE_EVENTS = [
    { id: "TE-01", date: "2023-04", title: "Tableau Cloud rollout begins",                signal: "positive", cap_impact: "P4C2", evidence: ["E-250"] },
    { id: "TE-02", date: "2023-11", title: "nCino core migration announced (Q2 2026 target)", signal: "neutral",  cap_impact: "P4C4", evidence: ["E-047"] },
    { id: "TE-03", date: "2024-08", title: "Acquisition of Hudson Valley CU branches",    signal: "neutral",  cap_impact: "P2C1", evidence: [] },
    { id: "TE-04", date: "2024-12", title: "AML enforcement action - FRB consent order",  signal: "negative", cap_impact: "P1C2", evidence: ["E-218"] },
    { id: "TE-05", date: "2025-06", title: "5,000 employee Tableau full enablement",      signal: "positive", cap_impact: "P4C2", evidence: ["E-250"] },
    { id: "TE-06", date: "2026-01", title: "5x Data Cloud Architect openings posted",      signal: "positive", cap_impact: "P4C1", evidence: ["E-112"] },
    { id: "TE-07", date: "2026-04", title: "CTO hired from Wells Fargo",                  signal: "positive", cap_impact: "P1C4", evidence: ["E-203"] },
    { id: "TE-08", date: "2026-05", title: "CDO hire - multi-year data transformation",   signal: "positive", cap_impact: "P4C1", evidence: ["E-203"] },
  ];

  /* ── Leadership (Client Profile) + Clay enrichment ─────────── */
  const LEADERSHIP = [
    { id: "EX-01", name: "Mark Hochberg",   title: "CEO",  tenure_months: 38, background: "Previously COO at AgFirst Farm Credit Bank. 24 years FSI experience.", critical_role: false, clay: { email: "m.hochberg@farmcrediteast.com", linkedin: "linkedin.com/in/mhochberg" }, evidence: ["E-203"] },
    { id: "EX-02", name: "Diana Solis",     title: "CTO",  tenure_months: 2,  background: "From Wells Fargo (8 yrs, head of Commercial Tech). Hired April 2026.", critical_role: true,  recent_hire: true, clay: { email: "d.solis@farmcrediteast.com", linkedin: "linkedin.com/in/dianasolis" }, evidence: ["E-203"] },
    { id: "EX-03", name: "Raj Iyer",        title: "CDO",  tenure_months: 1,  background: "From JPM Chase (Data Cloud lead, FSI). Joined May 2026.",                  critical_role: true,  recent_hire: true, clay: { email: "r.iyer@farmcrediteast.com", linkedin: "linkedin.com/in/rajiyer-data" }, evidence: ["E-203"] },
    { id: "EX-04", name: "Linnea Beck",     title: "CFO",  tenure_months: 19, background: "Previously CFO at NY Community Bank. CPA.", critical_role: false, clay: { email: "l.beck@farmcrediteast.com", linkedin: "linkedin.com/in/lbeck-cfo" }, evidence: [] },
    { id: "EX-05", name: "-",                title: "CISO", tenure_months: null, background: "No confirmed CISO from publicly available evidence.", critical_role: true, gap_flag: true, clay: null, evidence: [] },
    { id: "EX-06", name: "Karim Hadid",     title: "CHRO", tenure_months: 44, background: "Long-tenured CHRO. Led 2024 talent strategy refresh.", critical_role: false, clay: { email: "k.hadid@farmcrediteast.com", linkedin: "linkedin.com/in/kahadid" }, evidence: [] },
  ];

  /* ── Thought leadership signals (LinkedIn posts, panels, articles) ─ */
  const THOUGHT_LEADERSHIP = [
    { id: "TL-01", author: "Diana Solis (CTO)",  type: "LinkedIn post",  date: "2026-05-14", title: "Why we're investing in a unified customer data layer before re-platforming our core",        excerpt: "Data fragmentation is the constraint behind every CX investment we've seen. Closing it changes everything…", url: "linkedin.com/posts/dianasolis-..." },
    { id: "TL-02", author: "Mark Hochberg (CEO)", type: "Conference",     date: "2026-04-22", title: "Panel · The agricultural lender of 2030 - what scale and member experience need to look like", excerpt: "We talked about the integration debt across three cores and how nCino is just the first step.",         url: "fce.com/news/icba-2026-panel" },
    { id: "TL-03", author: "Raj Iyer (CDO)",     type: "Article",        date: "2026-05-30", title: "From reports to actions - what 'data-driven decisioning' actually means",                        excerpt: "Tableau adoption is widespread; outcomes that act on insights are not. Mosaic AI is our bridge.",        url: "fce.com/insights/raj-iyer-mosaic" },
  ];

  /* ── Roadmap (Transformation roadmap) ────────────────────────── */
  const ROADMAP = [
    { phase: 1, label: "Foundation",      duration: "0–6 mo",   color: "var(--z-dark2)", recs: ["REC-04","REC-09"], target: "M2 → M3 in P4C1, P3C2",                                                                  metric: "Unified customer profile · loan cycle ↓ 40%",     platform: "SF Data Cloud + nCino" },
    { phase: 2, label: "Customer layer",  duration: "6–12 mo",  color: "var(--z-mid)",   recs: ["REC-07","REC-18"], target: "M2 → M3 in P2C1, P2C4",                                                                  metric: "Multi-channel attribution · branch deflection +18pts", platform: "SF Marketing + Twilio Engage" },
    { phase: 3, label: "Decisioning",     duration: "12–18 mo", color: "var(--z-teal)",  recs: ["REC-14"],          target: "M3 → M4 in P4C2, P4C3",                                                                  metric: "Real-time decisioning · risk scoring",            platform: "Databricks Mosaic AI" },
  ];
  ...
  const STAIRSTEP_CLUSTERS = {
    "P4-data": {
      ...
      current: 2.1,
      steps: [
        { m: 2, label: "Building",       pct: 100, platforms: ["-"],          note: "Today - fragmented across 3 cores" },
        { m: 3, label: "Competing",      pct: 100, platforms: ["SF"],         note: "Salesforce Data Cloud - unified customer profile" },
        { m: 4, label: "Differentiating", pct: 100, platforms: ["DB"],        note: "Databricks Lakehouse - operational + ML-ready" },
        { m: 5, label: "Leading",        pct: 100, platforms: ["DB","SF"],   note: "Mosaic AI on Lakehouse - real-time decisioning" },
      ]
    },
    "P3-loans": {
      ...
      current: 1.8,
      steps: [
        { m: 2, label: "Building",       pct: 100, platforms: ["-"],          note: "Today - 85% manual, 12-day cycle" },
        { m: 3, label: "Competing",      pct: 100, platforms: ["nCino"],     note: "nCino Workflow Engine - 4-day cycle" },
        { m: 4, label: "Differentiating", pct: 100, platforms: ["nCino","SF"], note: "Service Cloud servicing layer - post-origination" },
        { m: 5, label: "Leading",        pct: 100, platforms: ["nCino","DB"], note: "Mosaic AI underwriting - automated decisioning" },
      ]
    }
  };
  ...
  const EVIDENCE_TIERS = {
    T1: { label: "Primary disclosure",    desc: "10-K · annual report · regulator filing · official press release", color: "var(--z-mid)",   bg: "var(--z-ice)",       weight: 1.00 },
    T2: { label: "Earnings & investor",   desc: "Earnings call transcript · investor day · official IR comms",       color: "var(--m-cmp)",   bg: "var(--z-ice)",       weight: 0.92 },
    T3: { label: "Trade press · analyst",  desc: "WSJ · Bloomberg · industry analyst report",                          color: "var(--ph1)",     bg: "var(--ph1-lt)",      weight: 0.80 },
    T4: { label: "Marketing claim",        desc: "Vendor website · co-branded press · case study (entity-published)",  color: "var(--z-org)",   bg: "rgba(254,151,50,.14)", weight: 0.55 },
    T5: { label: "Analyst inference",      desc: "Estimate based on industry pattern · proxy from peer behaviour",      color: "var(--z-dpur)",  bg: "var(--ph0-lt)",      weight: 0.50 },
    T6: { label: "Sentiment / review",     desc: "Glassdoor · App Store · CFPB complaints · indexed",                   color: "var(--z-purple)",bg: "var(--z-lav)",       weight: 0.45 },
    T7: { label: "Job posting · proxy",    desc: "LinkedIn / Indeed listings · BLS jobs data · proxy signal",           color: "var(--z-blue)",  bg: "var(--ph1-lt)",      weight: 0.42 },
    T8: { label: "Social / hypothesis",    desc: "Twitter / Reddit · low-confidence signal · hypothesis only",          color: "var(--z-muted)", bg: "var(--z-lav)",       weight: 0.25 },
  };
  ...
  const FOCUS_AREAS = [
    {
      ...
      source: { type: "Client Profile", page: 7, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "10-K FY2025 - Strategic Initiatives",
      subcaps: ["P2C1.1.1","P2C1.1.2","P2C3.1.1","P2C3.2.1","P4C1.2.1","P4C1.3.1","P4C5.1.1"],
      pillars_weight: { P1: 10, P2: 50, P3: 10, P4: 30 },
      icon: "envelope",
      colors: ["var(--z-teal)", "var(--m-bld)"],
      illustration: "brand/illustrations/horizon_minimal_band.jpg",
      kpis: [
        { label: "Channel conversion", current: "2.8%", target: "4.2%", delta: "+1.4pt" },
        { label: "Opening time",        current: "9 min", target: "3 min", delta: "−66%" },
        { label: "Branch dependency",   current: "44%",   target: "18%",   delta: "−26pt" },
      ],
    },
    {
      id: "FA-02",
      ...
      source: { type: "Client Profile", page: 11, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "Q1 2026 earnings call - CIO remarks",
      subcaps: ["P4C2.2.1","P4C3.1.1","P4C3.2.1","P4C3.3.1","P4C1.3.1","P2C4.1.1"],
      pillars_weight: { P1: 5, P2: 15, P3: 10, P4: 70 },
      icon: "sparkle",
      colors: ["var(--z-dpur)", "var(--ph0)"],
      illustration: "brand/illustrations/platform_dark_horizon.jpg",
      kpis: [
        { label: "Decisioning latency", current: "24h", target: "Real-time", delta: "−99%" },
        { label: "AI use cases live",   current: "0",   target: "3",          delta: "+3" },
        { label: "Model governance",    current: "Ad-hoc", target: "Formal",   delta: "-" },
      ],
    },
    {
      id: "FA-03",
      ...
      source: { type: "Client Profile", page: 13, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "Annual report - IT modernization disclosure",
      subcaps: ["P4C1.1.1","P4C1.1.2","P4C1.2.1","P4C1.3.1","P4C1.4.1","P4C4.2.1"],
      pillars_weight: { P1: 5, P2: 15, P3: 5, P4: 75 },
      icon: "stack",
      colors: ["var(--z-mid)", "var(--z-teal)"],
      illustration: "brand/illustrations/zen_garden_dark_mint.jpg",
      kpis: [
        { label: "Customer profile",   current: "Fragmented", target: "Unified", delta: "-" },
        { label: "Data quality score", current: "62%",        target: "92%",     delta: "+30pt" },
        { label: "Real-time ingestion", current: "0 streams",  target: "12",       delta: "+12" },
      ],
    },
    {
      id: "FA-04",
      ...
      source: { type: "Client Profile", page: 17, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "Q4 2025 10-Q - Loan portfolio commentary",
      subcaps: ["P3C2.1.1","P3C2.2.1","P3C2.3.1","P3C1.1.1","P4C1.1.3"],
      pillars_weight: { P1: 5, P2: 10, P3: 70, P4: 15 },
      icon: "route",
      colors: ["var(--z-blue)", "var(--ph1)"],
      illustration: "brand/illustrations/mountain_ladder_climbing.jpg",
      kpis: [
        { label: "Cycle time",       current: "12 days", target: "4 days", delta: "−66%" },
        { label: "STP rate",         current: "18%",     target: "55%",    delta: "+37pt" },
        { label: "Exception volume", current: "high",    target: "low",    delta: "−" },
      ],
    },
    {
      id: "FA-05",
      ...
      source: { type: "Client Profile", page: 21, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "Member sentiment survey - 2025 Q4",
      subcaps: ["P2C1.1.1","P2C1.2.1","P2C2.1.1","P2C2.2.1","P2C3.4.1","P2C4.1.1"],
      pillars_weight: { P1: 5, P2: 70, P3: 15, P4: 10 },
      icon: "users",
      colors: ["var(--z-org)", "var(--m-act)"],
      illustration: "brand/illustrations/pavilion_team_collaboration.jpg",
      kpis: [
        { label: "Mobile NPS",          current: "12", target: "38", delta: "+26" },
        { label: "App store rating",    current: "3.4",  target: "4.2", delta: "+0.8" },
        { label: "Branch deflection",   current: "32%",  target: "50%",  delta: "+18pt" },
      ],
    },
    {
      id: "FA-06",
      ...
      source: { type: "Client Profile", page: 25, doc: "FCE_DMA_Client_Profile_FINAL.docx" },
      financial_ref: "FRB consent order disclosure",
      subcaps: ["P1C2.1.1","P1C2.2.1","P4C5.1.1","P4C5.2.1","P4C5.3.1"],
      pillars_weight: { P1: 60, P2: 5, P3: 15, P4: 20 },
      icon: "shield",
      colors: ["var(--z-below)", "var(--m-act-t)"],
      illustration: "brand/illustrations/staircase_figures_descending.jpg",
      kpis: [
        { label: "Open enforcement",     current: "1 active", target: "0",          delta: "−1" },
        { label: "Control automation",    current: "32%",     target: "80%",       delta: "+48pt" },
        { label: "Audit cycle",           current: "Annual",   target: "Continuous", delta: "-" },
      ],
    },
  ];
  ...
  const ROADMAP_IMPACTS = {
    "REC-04": { initiative: "Salesforce Data Cloud", phase: 1, before: { P4: 2.1, P2: 2.5 }, after: { P4: 2.9, P2: 2.7 }, customer_impact: { latency: "−40%", profile_completeness: "+62pt", time_to_personalize: "−85%" }, dependencies: [] },
    "REC-09": { initiative: "nCino Workflow Engine",  phase: 1, before: { P3: 3.0 },         after: { P3: 3.5 },         customer_impact: { loan_cycle: "−40%", exception_rate: "−24pt", stp_rate: "+25pt" },                  dependencies: [] },
    "REC-07": { initiative: "Marketing Cloud + Twilio Engage", phase: 2, before: { P2: 2.7 }, after: { P2: 3.4 },         customer_impact: { branch_deflection: "+18pt", journey_attribution: "+100%", retention: "+9pt" },  dependencies: ["REC-04"] },
    "REC-18": { initiative: "Mobile self-service uplift",       phase: 2, before: { P2: 3.4 }, after: { P2: 3.8 },         customer_impact: { app_rating: "+0.8", branch_visits: "−22%", nps: "+15" },                       dependencies: ["REC-04","REC-07"] },
    "REC-14": { initiative: "Mosaic AI on Databricks",          phase: 3, before: { P4: 2.9, P2: 3.8 }, after: { P4: 3.8, P2: 4.2 }, customer_impact: { decision_latency: "Real-time", model_governance: "Formal", risk_score: "+18pt" }, dependencies: ["REC-04","REC-14"] },
  };

  /* ── Issue → subcap cap mapping (for heatmap issues overlay) ── */
  // Visible reference of which subcaps each issue caps and by how much
  const ISSUE_CAPS = {
    "IS-014": { caps: { "P1C2.2.1": 3.0, "P4C5.2.1": 3.0, "P4C5.3.1": 3.0 } },
    "IS-021": { caps: { "P4C1.1.1": 2.5, "P4C1.1.2": 2.5, "P4C1.3.1": 2.5, "P2C3.1.1": 2.5 } },
    "IS-027": { caps: { "P2C1.1.1": 3.5, "P2C1.2.1": 3.5 } },
  };

  /* ── Notifications (for the bell icon) ── */
  const NOTIFICATIONS = LIVE ? [] : [
    { id: "N-01", kind: "alert",      title: "8 new thin-evidence alerts",        body: "Farm Credit East · Batch 4 just ingested", when: "2 min ago", entity: "fce-001", route: "/alerts" },
    { id: "N-02", kind: "completion", title: "Synovus run completed",             body: "Overall 3.0 · 5 alerts open",               when: "1 h ago",   entity: "syn-001", route: "/clients/syn-001/overview" },
    { id: "N-03", kind: "system",     title: "Drive crawl complete",              body: "187 candidates · 6 routed to audit",         when: "2 h ago",   entity: null,      route: "/admin/import/audit" },
    { id: "N-04", kind: "completion", title: "SL Green run completed",            body: "Overall 3.1 · 3 alerts open",                when: "8 h ago",   entity: "slg-001", route: "/clients/slg-001/overview" },
    { id: "N-05", kind: "alert",      title: "Citizens Financial scoring started", body: "Batch 2 / 6 in progress",                    when: "1 d ago",   entity: "ctzn-001", route: "/clients/ctzn-001/overview" },
  ];
  ...
  const TECH_STACK = [
    ...
    { id: "TS-02", name: "nCino Loan Origination",    layer: "L2", layer_full: "Operations & core banking", status: "CONFIRMED",  source: ["Explorium","Press release","Job posting"], since: "2025-Q3", evidence: ["E-047","E-089"], subcaps_impact: ["P2C1.1.2","P3C2.3.1","P4C1.1.3"], note: "LOS go-live Q3 2025 · agricultural lending focus · 5 admin roles open", peer_coverage: 0.44, dma_pillar: "P3" },
    { id: "TS-03", name: "MuleSoft / integration bus", layer: "L2", layer_full: "Operations & core banking", status: "ABSENT",    source: ["Explorium"],                  since: null, evidence: [], subcaps_impact: ["P4C1.1.3"], note: "No integration platform detected · API gap between FIS Profile and nCino · IMP-001", peer_coverage: 0.46, dma_pillar: "P4" },

    // L3 Customer engagement
    { id: "TS-04", name: "Member digital banking portal", layer: "L3", layer_full: "Customer engagement", status: "INFERRED",  source: ["Assessment","Job posting"], since: "2021-Q1", evidence: ["E-103"], subcaps_impact: ["P2C1.1.1"], note: "Custom-built · no vendor platform detected", peer_coverage: 0.22, dma_pillar: "P2" },
    { id: "TS-05", name: "Salesforce Sales Cloud / FSC", layer: "L3", layer_full: "Customer engagement", status: "ABSENT", primary_gap: true, source: ["Explorium"], since: null, evidence: [], subcaps_impact: ["P2C2.1.1","P2C4.1.2"], note: "No CRM detected · biggest L3 gap · blocks Member 360 + pipeline mgmt", peer_coverage: 0.66, dma_pillar: "P2" },
    { id: "TS-06", name: "Salesforce Marketing Cloud", layer: "L3", layer_full: "Customer engagement", status: "ABSENT", source: ["Explorium","Job posting"], since: null, evidence: ["E-089"], subcaps_impact: ["P2C3.2.1"], note: "5 Marketing Cloud roles posted Q1 2026 - intent signal", peer_coverage: 0.39, dma_pillar: "P2" },
    { id: "TS-07", name: "Agentforce (AI service)",   layer: "L3", layer_full: "Customer engagement", status: "ABSENT", source: ["Explorium"], since: null, evidence: [], subcaps_impact: ["P2C4.3.1"], note: "No AI service deployed · nCino go-live = natural integration window", peer_coverage: 0.12, dma_pillar: "P2" },
    { id: "TS-08", name: "Twilio Engage",             layer: "L3", layer_full: "Customer engagement", status: "ABSENT", source: ["Explorium"], since: null, evidence: [], subcaps_impact: ["P2C1.2.1"], note: "No omnichannel comms platform", peer_coverage: 0.27, dma_pillar: "P2" },

    // L4 Data & analytics
    { id: "TS-09", name: "Tableau Cloud",             layer: "L4", layer_full: "Data & analytics", status: "CONFIRMED", source: ["Press release"], since: "2023-04", evidence: ["E-250","E-283"], subcaps_impact: ["P4C2.1.1","P4C2.2.1"], note: "Enterprise rollout · 1,800 users", peer_coverage: 0.72, dma_pillar: "P4" },
    { id: "TS-10", name: "Power BI (limited)",        layer: "L4", layer_full: "Data & analytics", status: "INFERRED", source: ["Job posting"], since: "2024-Q2", evidence: [], subcaps_impact: ["P4C2.4.1"], note: "Power BI skills in 3 finance roles · not confirmed as enterprise", peer_coverage: 0.41, dma_pillar: "P4" },
    { id: "TS-11", name: "Salesforce Data Cloud / CDP", layer: "L4", layer_full: "Data & analytics", status: "ABSENT", primary_gap: true, source: ["Explorium"], since: null, evidence: ["E-112"], subcaps_impact: ["P4C1.2.1","P4C1.3.1"], note: "Prerequisite for unified member profile and Agentforce", peer_coverage: 0.18, dma_pillar: "P4" },
    { id: "TS-12", name: "Databricks / Mosaic AI",    layer: "L4", layer_full: "Data & analytics", status: "ABSENT", source: ["Explorium"], since: null, evidence: [], subcaps_impact: ["P4C2.3.1","P4C3.1.1"], note: "No ML platform · advanced analytics gap", peer_coverage: 0.22, dma_pillar: "P4" },

    // L5 Infrastructure
    { id: "TS-13", name: "Microsoft Azure",            layer: "L5", layer_full: "Infrastructure & cloud", status: "CONFIRMED", source: ["Job posting"], since: "2022-Q4", evidence: ["E-112"], subcaps_impact: ["P4C4.1.1"], note: "Primary cloud · 200+ engineers tagged", peer_coverage: 0.61, dma_pillar: "P4" },
    { id: "TS-14", name: "Okta (Identity)",            layer: "L5", layer_full: "Infrastructure & cloud", status: "CONFIRMED", source: ["Job posting"], since: "2021-Q2", evidence: [], subcaps_impact: ["P4C5.1.1"], note: "Enterprise IDP · workforce + customer-facing", peer_coverage: 0.71, dma_pillar: "P4" },
  ];
  ...
  const ENTITIES = LIVE ? (LIVE.entities || []) : [
    {
      id: "fce-001", slug: "farm-credit-east", name: "Farm Credit East",
      domain: "farmcrediteast.com", ticker: null, subvertical: "FARM_CREDIT",
      size_tier: "MEDIUM", assets: 11.3e9, hq: "Enfield, CT", footprint: ["CT","NY","NJ","MA","NH"],
      regulator: "Farm Credit Administration", license: "Federal land bank",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: "2026-06-01", assessment_id: "DMA-ASM-FCE-20260601-0001",
      overall: 2.8, pillar_scores: { P1: 3.2, P2: 2.5, P3: 3.0, P4: 2.1 },
      open_alerts: 8, oss: { SF: 82, DB: 41, TBL: 24, TW: 36, nCino: 28 },
      employees: 1900, branches: 25, cagr: 0.082, trend: "ACCELERATING",
      runs: [
        { id: "DMA-ASM-FCE-20260601-0001", date: "2026-06-01", status: "ACTIVE",     data_source: "PROJECT_API", overall: 2.8, evidence_mode: "HYBRID",   subcap_count: 708 },
        { id: "DMA-ASM-FCE-20260201-0001", date: "2026-02-01", status: "SUPERSEDED", data_source: "PROJECT_API", overall: 2.6, evidence_mode: "INTERNAL", subcap_count: 708 },
        { id: "DMA-ASM-FCE-20251001-0001", date: "2025-10-01", status: "SUPERSEDED", data_source: "DRIVE_PARSE", overall: 2.4, evidence_mode: "PUBLIC",   subcap_count: 580 },
      ],
    },
    {
      id: "slg-001", slug: "sl-green", name: "SL Green Realty",
      domain: "slgreen.com", ticker: "SLG", subvertical: "REIT",
      size_tier: "LARGE", assets: 18.5e9, hq: "New York, NY", footprint: ["NY"],
      regulator: "-", license: "-",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: "2026-05-12", assessment_id: "DMA-ASM-SLGRN-20260512-0001",
      overall: 3.1, pillar_scores: { P1: 3.3, P2: 2.9, P3: 3.0, P4: 3.2 },
      open_alerts: 3, oss: { SF: 51, DB: 64, TBL: 33, TW: 18, nCino: 6 },
      employees: 1100, branches: 0, cagr: 0.041, trend: "STABLE",
      runs: [{ id: "DMA-ASM-SLGRN-20260512-0001", date: "2026-05-12", status: "ACTIVE", data_source: "PROJECT_API", overall: 3.1, evidence_mode: "HYBRID", subcap_count: 708 }],
    },
    {
      id: "ful-001", slug: "fulton-bank", name: "Fulton Bank",
      domain: "fultonbank.com", ticker: "FULT", subvertical: "REGIONAL_BANK",
      size_tier: "LARGE", assets: 27.6e9, hq: "Lancaster, PA", footprint: ["PA","NJ","MD","DE","VA"],
      regulator: "OCC", license: "National bank",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: "2026-04-22", assessment_id: "DMA-ASM-FULT-20260422-0001",
      overall: 2.6, pillar_scores: { P1: 2.7, P2: 2.4, P3: 2.5, P4: 2.7 },
      open_alerts: 12, oss: { SF: 76, DB: 58, TBL: 28, TW: 44, nCino: 51 },
      employees: 3400, branches: 198, cagr: 0.054, trend: "STABLE",
      runs: [
        { id: "DMA-ASM-FULT-20260422-0001", date: "2026-04-22", status: "ACTIVE",     data_source: "PROJECT_API", overall: 2.6, evidence_mode: "HYBRID", subcap_count: 708 },
        { id: "DMA-ASM-FULT-20251110-0001", date: "2025-11-10", status: "SUPERSEDED", data_source: "DRIVE_PARSE", overall: 2.4, evidence_mode: "PUBLIC", subcap_count: 590 },
      ],
    },
    {
      id: "zb-001", slug: "zions-bancorporation", name: "Zions Bancorporation",
      domain: "zionsbancorporation.com", ticker: "ZION", subvertical: "REGIONAL_BANK",
      size_tier: "LARGE", assets: 87.9e9, hq: "Salt Lake City, UT", footprint: ["UT","CA","NV","AZ","CO","WA","ID","TX"],
      regulator: "OCC", license: "National bank holding co.",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: "2026-05-03", assessment_id: "DMA-ASM-ZION-20260503-0001",
      overall: 3.4, pillar_scores: { P1: 3.7, P2: 3.5, P3: 3.2, P4: 3.2 },
      open_alerts: 2, oss: { SF: 38, DB: 47, TBL: 14, TW: 22, nCino: 18 },
      employees: 9700, branches: 414, cagr: 0.035, trend: "STABLE",
      runs: [{ id: "DMA-ASM-ZION-20260503-0001", date: "2026-05-03", status: "ACTIVE", data_source: "PROJECT_API", overall: 3.4, evidence_mode: "HYBRID", subcap_count: 708 }],
    },
    {
      id: "pcan-001", slug: "payments-canada", name: "Payments Canada",
      domain: "payments.ca", ticker: null, subvertical: "FINTECH_SAAS",
      size_tier: "MEDIUM", assets: 0, hq: "Ottawa, ON", footprint: ["CA"],
      regulator: "Bank of Canada", license: "Designated payment system",
      status: "ACTIVE", data_source: "DRIVE_PARSE",
      assessment_date: "2025-09-18", assessment_id: "DMA-ASM-PMTCAN-20250918-0001",
      overall: 2.2, pillar_scores: { P1: 2.8, P2: 1.9, P3: 2.4, P4: 1.8 },
      open_alerts: 14, oss: { SF: 43, DB: 71, TBL: 49, TW: 12, nCino: 8 },
      employees: 480, branches: 0, cagr: null, trend: "VARIABLE",
      runs: [{ id: "DMA-ASM-PMTCAN-20250918-0001", date: "2025-09-18", status: "ACTIVE", data_source: "DRIVE_PARSE", overall: 2.2, evidence_mode: "PUBLIC", subcap_count: 612 }],
      drive_note: "Phase 0 - parsed from research handoff Sep 2025. Data completeness may vary from a Phase 1 structured run.",
    },
    {
      id: "syn-001", slug: "synovus", name: "Synovus Financial",
      domain: "synovus.com", ticker: "SNV", subvertical: "REGIONAL_BANK",
      size_tier: "LARGE", assets: 60.3e9, hq: "Columbus, GA", footprint: ["GA","AL","FL","SC","TN","NC"],
      regulator: "Federal Reserve / FDIC", license: "State member bank",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: "2026-05-25", assessment_id: "DMA-ASM-SNV-20260525-0001",
      overall: 3.0, pillar_scores: { P1: 3.1, P2: 3.2, P3: 2.8, P4: 2.9 },
      open_alerts: 5, oss: { SF: 64, DB: 51, TBL: 19, TW: 31, nCino: 26 },
      employees: 4900, branches: 244, cagr: 0.061, trend: "STABLE",
      runs: [{ id: "DMA-ASM-SNV-20260525-0001", date: "2026-05-25", status: "ACTIVE", data_source: "PROJECT_API", overall: 3.0, evidence_mode: "HYBRID", subcap_count: 708 }],
      in_progress: false,
    },
    {
      id: "ctzn-001", slug: "citizens-financial", name: "Citizens Financial Group",
      domain: "citizensbank.com", ticker: "CFG", subvertical: "REGIONAL_BANK",
      size_tier: "ENTERPRISE", assets: 222.3e9, hq: "Providence, RI", footprint: ["RI","MA","CT","NJ","NY","PA","OH","NH","DE","VT","FL"],
      regulator: "Federal Reserve", license: "State member bank",
      status: "ACTIVE", data_source: "PROJECT_API",
      assessment_date: null, assessment_id: "DMA-ASM-CFG-20260603-0001",
      overall: null, pillar_scores: null,
      open_alerts: 0, oss: null,
      employees: 18000, branches: 1100, cagr: 0.025, trend: "STABLE",
      runs: [{ id: "DMA-ASM-CFG-20260603-0001", date: "2026-06-03", status: "RESEARCH_IN_PROGRESS", data_source: "PROJECT_API", overall: null, evidence_mode: "-", subcap_count: 0, current_batch: 2 }],
      in_progress: true,
    },
  ];
  ...
  const liveGates = () => (liveField(null, "gates") || []).map(g => ({
    ...
    // than an empty one.
    evidence: g.not_run_reason || (g.detail == null ? null
      : (typeof g.detail === "string" ? g.detail : JSON.stringify(g.detail))),
    not_run_reason: g.not_run_reason || null,
    e_ids: g.e_ids || [],
  })).filter(g => g.id);
  const QA_GATES = LIVE ? [] : [
    { id: "G01", name: "Source diversity",        status: "PASS", evidence: "Evidence across T1-T7 tiers" },
    { id: "G02", name: "Peer set integrity",      status: "PASS", evidence: "5 named peers locked for subvertical" },
    { id: "G03", name: "Subcap coverage",         status: "PASS", evidence: "708/708 subcaps scored" },
    { id: "G04", name: "Evidence per subcap",     status: "FAIL", evidence: "8 subcaps below threshold of 3" },
    { id: "G05", name: "Confidence calibration",  status: "PASS", evidence: "Confidence distribution within bounds" },
    { id: "G06", name: "Issue register coverage", status: "PASS", evidence: "4 active issues mapped" },
    { id: "G07", name: "Recommendations grounded",status: "PASS", evidence: "5/5 recommendations have ≥2 E-IDs" },
    { id: "G08", name: "Platform mapping",        status: "PASS", evidence: "All subcaps with score <3.0 mapped" },
    { id: "G09", name: "Internal-only flags",     status: "PASS", evidence: "Customer-safe fields verified" },
    { id: "G10", name: "Schema version",          status: "PASS", evidence: "Framework v5.5" },
  ];

  /* ── Import audit ───────────────────────────────────────────────── */
  const IMPORT_AUDIT = LIVE ? [] : [
    { id: "IA-01", filename: "Nyumba_Zetu_Final_Research_Report.gdoc",     rules: ["R02","R03"], status: "EXCLUDED",       owner: "dma@zennify.com",      modifiedTime: "2025-08-04", entity: "-",                  rationale: "PropTech (Nairobi) - non-FSI" },
    { id: "IA-02", filename: "DMA_Assessment_Report_ClientX.gdoc",         rules: ["R05"],       status: "REVIEW",         owner: "john.smith@clientx.com", modifiedTime: "2026-05-12", entity: "ClientX (inferred)", rationale: "Outside @zennify.com domain" },
    { id: "IA-03", filename: "Legacy_Assessment_STCU_Framework_v5.0.gdoc", rules: ["R06"],       status: "REVIEW",         owner: "dma@zennify.com",      modifiedTime: "2024-03-21", entity: "STCU (inferred)",    rationale: "Pre-v5.5 schema" },
    { id: "IA-04", filename: "Test_Assessment_Run.gdoc",                   rules: ["R01"],       status: "EXCLUDED",       owner: "dma@zennify.com",      modifiedTime: "2025-09-02", entity: "-",                  rationale: "Contains 'Test' in filename" },
    { id: "IA-05", filename: "DMA_Assessment_Report_Template_v3.docx",     rules: ["R04"],       status: "EXCLUDED",       owner: "dma@zennify.com",      modifiedTime: "2024-12-01", entity: "-",                  rationale: "Unfilled template tokens" },
    { id: "IA-06", filename: "Ag_Lending_Solution_Blueprint_v2.gdoc",      rules: ["R02"],       status: "EXCLUDED",       owner: "dma@zennify.com",      modifiedTime: "2025-07-15", entity: "-",                  rationale: "No Assessment ID - non-DMA artifact" },
  ];

  /* ── Pending review entities (Phase 0) ──────────────────────────── */
  const PENDING_REVIEW = LIVE ? (LIVE.pending_review || []) : [
    { id: "PR-01", inferred_name: "Provident Bank",  inferred_subvertical: "REGIONAL_BANK", confidence: 0.78, signal: "Entity name from document header", drive_file: "DMA_Assessment_Report_ProvBank.gdoc", date: "2026-06-04" },
    { id: "PR-02", inferred_name: "United FCS",       inferred_subvertical: "FARM_CREDIT",   confidence: 0.72, signal: "Filename token extraction",         drive_file: "United_FCS_Assessment_FINAL.gdoc",       date: "2026-06-02" },
  ];

  /* ── Peer benchmarks (selected) ─────────────────────────────────── */
  const PEER_SETS = {
    FARM_CREDIT:   { peers: ["Farm Credit Mid-America","AgFirst","CoBank","Northwest Farm Credit","American AgCredit"] },
    REGIONAL_BANK: { peers: ["First Citizens","M&T Bank","Synovus","BankUnited","Pinnacle Financial"] },
    REIT:          { peers: ["Boston Properties","Vornado","Brookfield Property","Empire State Realty","Kilroy Realty"] },
    FINTECH_SAAS:  { peers: ["Plaid","Marqeta","Stripe","Adyen","FIS"] },
  };
  ...
  const ACTIVE_RUNS = LIVE ? (LIVE.active_runs || []) : [
    { entity_id: "ctzn-001", current_batch: 2, started: "2026-06-03 09:12", eta_min: 38 },
  ];

  /* ── Cross-entity pattern (for D6) ──────────────────────────────── */
  const PATTERNS = LIVE ? [] : [
    { subvertical: "REGIONAL_BANK", category: "P4C3", title: "AI & Decisioning <2.5 in 67% of cohort", count: 4, total: 6 },
    { subvertical: "REGIONAL_BANK", category: "P4C1", title: "Data Foundation <2.5 in 50% of cohort",  count: 3, total: 6 },
    { subvertical: "FARM_CREDIT",   category: "P3C2", title: "Loan Origination workflows <2.5 in 60%", count: 3, total: 5 },
  ];
  ...
  const FINANCIALS = {
    "fce-001": {
      ...
      branches: 64, regulator: "FCA", geography: "NY · NJ · CT · MA · NH (5 states)",
      headline: "$12.2B assets · FY2025", events: [
        { fy: "FY2023", label: "nCino core migration announced" },
        { fy: "FY2025", label: "CDO hired · data transformation" },
      ],
    },
  };
  ...
  const SENTIMENT = {
    "fce-001": {
      employee: [
        { source: "Glassdoor",  metric: "Overall",          score: 3.6, scale: 5, n: 312 },
        { source: "Glassdoor",  metric: "CEO approval",      score: 3.9, scale: 5 },
        { source: "Glassdoor",  metric: "Culture & values",  score: 3.5, scale: 5 },
        { source: "Indeed",     metric: "Overall",           score: 3.4, scale: 5, n: 188 },
      ],
      customer: [
        { source: "App Store",  metric: "Mobile app",        score: 2.9, scale: 5, n: 1240, flag: "below_peer" },
        { source: "Google Play",metric: "Mobile app",        score: 3.1, scale: 5, n: 870 },
        { source: "BBB",        metric: "Customer rating",   score: 3.3, scale: 5 },
      ],
  ...
  const COVERAGE_STATS = {
    "fce-001": {
      overall_pct: 96,
      by_pillar: [
        { pillar: "P1", pct: 98, subcaps: 71,  scored: 71 },
        { pillar: "P2", pct: 94, subcaps: 290, scored: 273 },
        { pillar: "P3", pct: 97, subcaps: 165, scored: 160 },
        { pillar: "P4", pct: 95, subcaps: 182, scored: 173 },
      ],
      gate_pct: 80,
    },
  };
  ...
  const UNCERTAINTY_BANDS = {
    "fce-001": {
      P1C1: { ceiling: 3.0, band: 0.3, modifiers: [], evidence: ["E-047"], rationale: "Digital strategy is documented in the annual report; ceiling set at M3 because execution cadence is confirmed but no innovation-lab or dedicated transformation office is evidenced." },
      P1C2: { ceiling: 3.5, band: 0.4, modifiers: [], evidence: ["E-218"], rationale: "Governance ceiling constrained by the open AML consent order — remediation is on-track, so the band is moderate, but the cap holds until closure is confirmed." },
      P1C3: { ceiling: 2.5, band: 0.4, modifiers: ["+0.1 no innovation lab confirmed"], evidence: ["E-047","E-302"], rationale: "Operating-model maturity inferred from org disclosures; upside if an innovation function is later evidenced." },
      P1C4: { ceiling: 3.0, band: 0.5, modifiers: [], evidence: ["E-203"], rationale: "New CDO hire raises the leadership ceiling, but tenure is <6 months so the band is wide until direction is set." },
      P2C1: { ceiling: 3.0, band: 0.4, modifiers: [], evidence: ["E-271","E-311"], rationale: "Channel ceiling anchored by app-store sentiment and the Forrester mobile-servicing lag; both are indirect, hence the band." },
      P2C2: { ceiling: 3.0, band: 0.4, modifiers: ["+0.1 STP rate unknown"], evidence: ["E-271"], rationale: "Digital service model inferred from customer reviews; straight-through-processing rate is unconfirmed." },
      P2C3: { ceiling: 2.0, band: 0.5, modifiers: ["+0.1 channel utilization unknown"], evidence: ["E-340"], rationale: "Customer-journey ceiling low — self-service gaps evidenced only by community/social signal (T8), so confidence is low and band wide." },
      P2C4: { ceiling: 2.5, band: 0.5, modifiers: [], evidence: ["E-311"], rationale: "Personalization ceiling from analyst benchmark; no first-party evidence of a personalization engine." },
      P3C1: { ceiling: 3.0, band: 0.4, modifiers: [], evidence: ["E-047"], rationale: "Workflow-automation ceiling supported by the nCino migration disclosure." },
      P3C2: { ceiling: 2.0, band: 0.6, modifiers: ["+0.2 manual process depth uncertain"], evidence: ["E-236"], rationale: "Loan-origination ceiling constrained by Glassdoor operations reviews describing manual processing; depth of manual work is uncertain, so the band is the widest on the board." },
      P4C1: { ceiling: 2.5, band: 0.5, modifiers: ["+0.1 core consolidation in-flight"], evidence: ["E-047","E-141"], rationale: "Data-foundation ceiling capped by the three-core fragmentation disclosed in the 10-K; upside once consolidation completes." },
      P4C2: { ceiling: 3.5, band: 0.3, modifiers: [], evidence: ["E-250"], rationale: "Analytics ceiling is the highest — Tableau enterprise rollout is a confirmed press-release fact (T2)." },
      P4C3: { ceiling: 2.0, band: 0.6, modifiers: ["+0.2 no AI deploy evidence"], evidence: ["E-283"], rationale: "AI-decisioning ceiling low — only a Tableau Pulse hiring signal; no deployed decisioning evidence, so provisional." },
      P4C5: { ceiling: 3.0, band: 0.4, modifiers: [], evidence: ["E-218"], rationale: "Security & resiliency ceiling tied to the consent-order remediation scope." },
    },
  };
  ...
  const EVIDENCE_SUMMARY = {
    "fce-001": {
      ...
      tiers: { T1: 8, T2: 15, T3: 70, T4: 5, T5: 12 },
      claims: { FACT: 342, INFERENCE: 41, HYPOTHESIS: 0, CEILING_ESTIMATE: 4 },
      signals: { POSITIVE: 62, CONTRADICTORY: 17, NEGATIVE: 10, NEUTRAL: 21 },
      connectors: { Explorium: 15, Clay: 3, Indeed: 6 },
    },
  };
  ...
  const SOURCE_MAP = {
    score_ring:        { file: "03_scoring_workbook/export_pillar_summary.csv",   fields: ["Pillar","Score","Weight","Weighted"], transform: "Overall row = headline" },
    heatmap:           { file: "03_scoring_workbook/export_category_summary.csv", fields: ["Category","Score","Subcaps","Peer_Median","Gap","Priority"] },
    gap_waterfall:     { file: "03_scoring_workbook/export_category_summary.csv", fields: ["Gap"], also: "06_peers/peer_comparison_table.csv::Peer_P75" },
    peer_ranking:      { file: "06_peers/peer_comparison_table.csv",              fields: ["*_Ceiling","Peer_Median","Peer_P25","Peer_P75","*_vs_Median"] },
    evidence_tiers:    { file: "01_evidence/research_handoff.json",               fields: ["evidence_summary.tier_distribution","claim_distribution","signal_distribution"] },
    coverage_by_pillar:{ file: "03_scoring_workbook/export_coverage_stats.csv",   also: "research_handoff.json::coverage_percentage" },
    ceiling_estimate:  { file: "02_research_workbook/uncertainty_bands.json",     fields: ["base","modifiers","total"], also: "peer_comparison_table.csv::*_Ceiling" },
    financial_traj:    { file: "00_entity_profile/financial_baseline.json",       also: "entity_profile.json" },
    sentiment:         { file: "08_appendices/A6_sentiment_data.csv",             note: "naming drifts; match 'sentiment' token; INTERNAL-ONLY" },
    issue_timeline:    { file: "07_governance/issue_register.csv",                also: "07_governance/caps_applied_log.csv" },
    recommendations:   { file: "08_appendices/recommendations.json",              alt: "08_appendices/recommendations/REC-*.json + recommendations_master.json" },
    tech_stack:        { file: "08_appendices/*_Explorium_*.xlsx",                alt: "tech_stack.json / A4_tech_stack_map.csv" },
    qa_badge:          { file: "07_governance/qa_verdict.json",                   also: "run_manifest*.json" },
  };
  ...
  const ENTITY_ALIASES = {
    SSB: "SouthState Corporation", FCNCA: "First Citizens BancShares", CACU: "Corporate America Credit Union",
    CWB: "Community West Bank", MFCU: "Members 1st FCU", AMH: "American Homes 4 Rent", VNO: "Vornado Realty Trust",
    SLG: "SL Green Realty", TCB: "Texas Capital Bank", ANBTX: "American National Bank of Texas", GFCU: "Global FCU",
    OZK: "Bank OZK", TII: "Travel Insurance International", VFP: "Virtuity Financial Partners", CIF: "CI Financial",
    VESTGEN: "VestGen Wealth Partners", CFR: "Frost Bank", ABCB: "Ameris Bank", ZION: "Zions Bancorporation",
  };
  ...
  const WHY_NOW = {
    "fce-001": [
      {
        id: "WN-1", label: "Core migration mid-flight", category: "core_migration",
        strength: "STRONG", window: "closes Q2 2026", confidence: "HIGH", claim: "FACT",
        ...
        evidence: ["E-047", "E-141", "E-089"], timeline: { date: "2025-09", event: "nCino migration announced (Q1 earnings call)" },
        impact: "Position Data Cloud as the substrate underneath the new core — not a bolt-on after go-live.",
      },
      {
        id: "WN-2", label: "Two C-suite hires", category: "leadership",
        strength: "STRONG", window: "6–9 month policy window", confidence: "HIGH", claim: "INFERENCE",
        ...
        evidence: ["E-203", "E-047"], timeline: { date: "2026-04", event: "CTO hire announced (LinkedIn)" },
        impact: "Executive sponsorship is winnable now; align the data-foundation narrative to the CDO's mandate.",
      },
      {
        id: "WN-3", label: "5 Data Cloud Architect openings", category: "hiring",
        strength: "LEADING", window: "90–120 day lead signal", confidence: "MEDIUM", claim: "INFERENCE",
        ...
        evidence: ["E-112", "E-283"], timeline: { date: "2026-01", event: "5 Data Cloud Architect roles posted (Explorium)" },
        impact: "Engage before a point-solution creates the next decade of fragmentation.",
      },
      {
        id: "WN-4", label: "Analytics outpaces decisioning", category: "market",
        strength: "SUPPORTING", window: "structural", confidence: "HIGH", claim: "FACT",
        ...
        evidence: ["E-250", "E-283"], timeline: { date: "2025-11", event: "Tableau enterprise rollout completed (press release)" },
        impact: "Lead with activation (Data Cloud + Agentforce), not more BI — the reporting muscle already exists.",
      },
      {
        id: "WN-5", label: "AML consent order remediation", category: "regulatory",
        strength: "SUPPORTING", window: "18-month remediation clock", confidence: "HIGH", claim: "FACT",
        ...
        evidence: ["E-218"], timeline: { date: "2024-11", event: "FRB consent order issued" },
  ...
  function synthWhyNow(id) {
    ...
    if (g) {
      ...
      signals.push({
        id: "WN-1", label: `${(cat && cat.name) || g.category} is the deepest gap`, category: "market",
        strength: "STRONG", window: "structural", confidence: g.thin ? "LOW" : "MEDIUM", claim: "INFERENCE",
        ...
        evidence: evFor(g.id), timeline: { date: when, event: "Latest DMA run" },
    ...
    if (thin > 0) {
      signals.push({
        id: "WN-2", label: `${thin} subcaps on thin evidence`, category: "hiring",
        strength: "LEADING", window: "confirm before commit", confidence: "MEDIUM", claim: "HYPOTHESIS",
        ...
        evidence: [], timeline: { date: when, event: "Coverage from latest run" },
    ...
    if (e.oss) {
      ...
      if (top) {
        ...
        signals.push({
          id: "WN-3", label: `${(p && p.name) || top[0]} is the lead platform fit`, category: "core_migration",
          strength: "SUPPORTING", window: "next planning cycle", confidence: "MEDIUM", claim: "INFERENCE",
          ...
          evidence: [], timeline: { date: when, event: "Platform fit from latest run" },
  ...
  function insightPriority(c) {
    const flagW = { CRITICAL: 3, OPPORTUNITY: 2, MONITOR: 1 }[c.flag] || 1;
    const confW = { HIGH: 3, MEDIUM: 2, LOW: 1 }[c.confidence] || 1;
    ...
    if (c.flag === "CRITICAL" || (c.flag === "OPPORTUNITY" && c.confidence === "HIGH" && c.rec)) {
      tier = 1; tierLabel = "Act now"; tierColor = "below";
    } else if (c.flag === "OPPORTUNITY") {
      tier = 2; tierLabel = "Plan next"; tierColor = "org";
    } else {
      tier = 3; tierLabel = "Watch"; tierColor = "teal";
    }
    return { score, tier, tierLabel, tierColor, reach, actionable: !!c.rec };
  }
  ...
  window.DMA = {
    ...
    get EVIDENCE() { return LIVE ? (liveField(null, "evidence") || []) : EVIDENCE; },
    get INSIGHT_CARDS() { return LIVE ? (liveField(null, "insightCards") || []) : INSIGHT_CARDS; },
    ...
    get TECH_LAYERS() { return LIVE ? (liveField(null, "techLayers") || []) : []; },
    ...
    /* Computed at read from the enrichment register: per surface, which
       ...
       claim a scan ran. */
    get LIVE_ENRICHMENT() { return LIVE ? (liveField(null, "enrichment") || {}) : {}; },
    ...
    // empty one forever.
    get QA_GATES() { return LIVE ? liveGates() : QA_GATES; },
    ...
    get SAFEGUARD_CAPS() { return LIVE ? (liveField(null, "caps") || []) : []; },
    ...
    getRecommendation: id => (LIVE ? (liveField(null, "recommendations") || []).find(r => r.id === id)
                                   : (RECOMMENDATIONS.find(r => r.id === id) || RECS_CACHE[id])),
    recsFor: id => LIVE ? (liveField(id, "recommendations") || []) : recsFor(id),
    getFocusArea: id => (LIVE ? (liveField(null, "focusAreas") || [])
                              : FOCUS_AREAS).find(f => f.id === id),
    ...
    contextSentimentFor: id => LIVE
      ? (liveField(id, "contextSentiment") || liveField(id, "sentiment"))
      : (SENTIMENT[id] || SENTIMENT["fce-001"]),
