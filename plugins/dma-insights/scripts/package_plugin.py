...
def build_walkthrough(out_dir: Path, version: str) -> Path:
    ...
    tour = [
        ...
        "## agents/ — the 64-agent roster, hierarchical",
        ...
        "- research/  the research-conductor + categories/ with the 16",
        "  category-clustered researchers (one per catalogue category,",
        "  generated by scripts/gen_research_agents.py)",
