...
`engine.brief dispatch --run <R> --root <ROOT> --category P1C4` is your
...
Then `engine.cli orient --run <R> --root <ROOT> --category P1C4` for the
work card. When you finish, `engine.brief handback --run <R> --root <ROOT>
--category P1C4` is what you report — computed from the sheets, so the
...
- Your grain is `P1C4` and nothing else. `engine.cli orient --run <R>
  --root <ROOT> --category P1C4` serves your work card; its `do_first`
