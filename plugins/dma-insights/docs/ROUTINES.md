...
The live prompt, read back from the trigger after the 2026-08-20 dispatch-mode update (0.6.4: pre-synthesis
gate, claim-lease retry, recursive pull, memory canonicalisation, agent_run.py dispatch) — kept here verbatim
